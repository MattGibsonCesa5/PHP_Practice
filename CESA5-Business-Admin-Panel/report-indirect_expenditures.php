        ...
        if (isset($_SESSION["role"]) && $_SESSION["role"] == 1)
        {
            ...
            ?>
                    ...
                    <div class="table-header p-0">
                        <div class="row d-flex justify-content-center align-items-center text-center py-2 px-3 m-0">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-8 col-xxl-8 p-0">
                                <h1 class="report-title m-0">Indirect Expenditures Report</h1>
                            </div>
                        ...
                        <table id="report_table" class="report_table w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th>Project Name</th>
                                    <th>Indirect Rate</th>
                                    <th>Indirect Label</th>
                                    <th>Total Budgeted Expenditures</th>
                                    <th>Total Indirect Expenditures</th>
                                    <th>Budgeted - Indirect</th>
                                    <th>Total Budgeted Expenditures</th>
                                    <th>Total Indirect Expenditures</th>
                                    <th>Budgeted - Indirect</th>
                                </tr>
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="4"></th>
                                    <th id="sum-total"></th>
                                    <th id="sum-indirect"></th>
                                    <th id="sum-diff"></th>
                                    <th colspan="3"></th>
                                </tr>
                            </tfoot>
                        </table>
                        <?php createTableFooterV2("report_table", "BAP_Report_IndirectExpenditures_PageLength", $USER_SETTINGS["page_length"], true, true); ?>
                    </div>
                </div>
                ...
                <script>
                    ...
                    if (sessionStorage["BAP_Report_IndirectExpenditures_Search_Period"] != "" && sessionStorage["BAP_Report_IndirectExpenditures_Search_Period"] != null && sessionStorage["BAP_Report_IndirectExpenditures_Search_Period"] != undefined) { $('#search-period').val(sessionStorage["BAP_Report_IndirectExpenditures_Search_Period"]); }
                    ...
                    function generateReport()
                    {
                        ...
                        if (period != null && period != undefined && period != "")
                        {
                            ...
                            sessionStorage["BAP_Report_IndirectExpenditures_Search_Period"] = period;

                            // initialize and get the report data
                            var report = $("#report_table").DataTable({
                                ajax: {
                                    url: "ajax/reports/getIndirectExpendituresReport.php",
                                    type: "POST",
                                    data: {
                                        period: period,
                                    }
                                ...
                                columns: [
                                    ...
                                    { data: "name", orderable: true, className: "text-center" },
                                    ...
                                    { data: "indirect", orderable: true, className: "text-center" },
                                    { data: "diff", orderable: true, className: "text-center" },
                                    { data: "calc_total", orderable: true, className: "text-center", visible: false },
                                    { data: "calc_indirect", orderable: true, className: "text-center", visible: false },
                                    { data: "calc_diff", orderable: true, className: "text-center", visible: false },
                                ],
                                order: [
                                    [ 0, "asc" ],
                                ],
                                ...
                                drawCallback: function ()
                                {
                                    ...
                                    // get sum of units
                                    let total_sum = api.column(7, { search: "applied" }).data().sum();
                                    let indirect_sum = api.column(8, { search: "applied" }).data().sum();
                                    let diff_sum = api.column(9, { search: "applied" }).data().sum();

                                    // update the table footer
                                    document.getElementById("sum-total").innerHTML = "$"+numberWithCommas(total_sum.toFixed(2));
                                    document.getElementById("sum-indirect").innerHTML = "$"+numberWithCommas(indirect_sum.toFixed(2));
                                    document.getElementById("sum-diff").innerHTML = "$"+numberWithCommas(diff_sum.toFixed(2));
                                },
                            });
                            ...
                            new $.fn.dataTable.Buttons(report, {
                                buttons: [
                                    // CSV BUTTON
                                    {
                                        ...
                                        title: "IndirectExpenditures Report",
                            ...
                            $('#search-all').keyup(function() {
                                ...
                                sessionStorage["BAP_Report_IndirectExpenditures_Search_All"] = $(this).val();
                            });

                            // function to clear search filters
                            $('#clearFilters').click(function() {
                                sessionStorage["BAP_Report_IndirectExpenditures_Search_All"] = "";
                                $('#search-all').val("");
