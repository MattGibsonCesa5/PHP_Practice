    ...
    if (isset($_SESSION["status"]) && $_SESSION["status"] == 1)
    {
        ...
        if (checkUserPermission($conn, "DELETE_INVOICES"))
        {
            ...
            if ($invoice_id != null && is_numeric($invoice_id))
            {
                ...
                $checkInvoice = mysqli_prepare($conn, "SELECT id FROM services_provided WHERE id=?");
                ...
                if (mysqli_stmt_execute($checkInvoice))
                {
                    ...
                    {
                        ?>
                            <div class="modal fade" tabindex="-1" role="dialog" id="deleteInvoiceModal" data-bs-backdrop="static" aria-labelledby="deleteInvoiceModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header primary-modal-header">
                                            <h5 class="modal-title primary-modal-title" id="deleteInvoiceModalLabel">Delete Invoice</h5>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" onclick="deleteInvoice('<?php echo $invoice_id; ?>');"><i class="fa-solid fa-trash-can"></i> Delete Invoice</button>
