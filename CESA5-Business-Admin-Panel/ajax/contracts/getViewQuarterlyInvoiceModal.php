<?php 
    ...
    if (isset($_SESSION["status"]) && $_SESSION["status"] == 1)
    {
        ...
        if (checkUserPermission($conn, "VIEW_QUARTERLY_INVOICES"))
        {
            ...
            if ($period_id != null && $quarter != null && $customer_id != null)
            {
                        ...
                        if (mysqli_num_rows($checkPeriodResult) > 0) // period exists; continue
                        {
                            ...
                            if (mysqli_stmt_execute($checkCustomer))
                            {
                                ...
                                if (mysqli_num_rows($checkCustomerResult) > 0) // customer exists; continue
                                {
                                    ...
                                    $filename = "local_data/quarter_contracts/$period_id/$quarter/$customer_id.pdf";
                                            ...
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h2><?php echo $customer_name; ?> (<?php echo $period_name; ?> Q<?php echo $quarter; ?>)</h2>
