<?php 
    ...
    if (isset($_SESSION["status"]) && $_SESSION["status"] == 1)
    {
        if (isset($_SESSION["role"]) && $_SESSION["role"] == 1)
        {
            ...
            if (isset($_POST["dashboard_show_employee"]) && is_numeric($_POST["dashboard_show_employees"])) { $dashboard_show_employees = $_POST["dashboard_show_employees"]; } else { $dashboard_show_employees = 0; }
            ...
            if ($role_name != null && trim($role_name) <> "")
            {
                ...
                try
                {
                    $addRole = mysqli_prepare($conn, "INSERT INTO roles (name) VALUES (?)");
                    mysqli_stmt_bind_param($addRole, "s", $role_name);
                    if (mysqli_stmt_execute($addRole)) // successfully added the role; set role permissions
                    {
                        // get the new role ID
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_employees_all == 1) { setPermission($conn, $role_id, "VIEW_EMPLOYEES_ALL"); }
                        if ($view_employees_assigned == 1 && $view_employees_all != 1) { setPermission($conn, $role_id, "VIEW_EMPLOYEES_ASSIGNED"); }
                        if ($add_employees == 1) { setPermission($conn, $role_id, "ADD_EMPLOYEES"); }
                        if ($edit_employees  == 1) { setPermission($conn, $role_id, "EDIT_EMPLOYEES"); }
                        if ($delete_employees == 1) { setPermission($conn, $role_id, "DELETE_EMPLOYEES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_departments_all == 1) { setPermission($conn, $role_id, "VIEW_DEPARTMENTS_ALL"); }
                        if ($view_departments_assigned == 1 && $view_departments_all != 1) { setPermission($conn, $role_id, "VIEW_DEPARTMENTS_ASSIGNED"); }
                        if ($add_departments == 1) { setPermission($conn, $role_id, "ADD_DEPARTMENTS"); }
                        if ($edit_departments  == 1) { setPermission($conn, $role_id, "EDIT_DEPARTMENTS"); }
                        if ($delete_departments == 1) { setPermission($conn, $role_id, "DELETE_DEPARTMENTS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_project_expenses == 1) { setPermission($conn, $role_id, "VIEW_PROJECT_EXPENSES"); }
                        if ($add_project_expenses == 1) { setPermission($conn, $role_id, "ADD_PROJECT_EXPENSES"); }
                        if ($edit_project_expenses  == 1) { setPermission($conn, $role_id, "EDIT_PROJECT_EXPENSES"); }
                        if ($delete_project_expenses == 1) { setPermission($conn, $role_id, "DELETE_PROJECT_EXPENSES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_employee_expenses == 1) { setPermission($conn, $role_id, "VIEW_EMPLOYEE_EXPENSES"); }
                        if ($edit_employee_expenses == 1) { setPermission($conn, $role_id, "EDIT_EMPLOYEE_EXPENSES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_services_all == 1) { setPermission($conn, $role_id, "VIEW_SERVICES_ALL"); }
                        if ($view_services_assigned == 1 && $view_services_all != 1) { setPermission($conn, $role_id, "VIEW_SERVICES_ASSIGNED"); }
                        if ($add_services == 1) { setPermission($conn, $role_id, "ADD_SERVICES"); }
                        if ($edit_services  == 1) { setPermission($conn, $role_id, "EDIT_SERVICES"); }
                        if ($delete_services == 1) { setPermission($conn, $role_id, "DELETE_SERVICES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_invoices_all == 1) { setPermission($conn, $role_id, "VIEW_INVOICES_ALL"); }
                        if ($view_invoices_assigned == 1 && $view_invoices_all != 1) { setPermission($conn, $role_id, "VIEW_INVOICES_ASSIGNED"); }
                        if ($add_invoices == 1) { setPermission($conn, $role_id, "ADD_INVOICES"); }
                        if ($edit_invoices  == 1) { setPermission($conn, $role_id, "EDIT_INVOICES"); }
                        if ($delete_invoices == 1) { setPermission($conn, $role_id, "DELETE_INVOICES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_other_services == 1) { setPermission($conn, $role_id, "VIEW_OTHER_SERVICES"); }
                        if ($add_other_services == 1) { setPermission($conn, $role_id, "ADD_OTHER_SERVICES"); }
                        if ($edit_other_services == 1) { setPermission($conn, $role_id, "EDIT_OTHER_SERVICES"); }
                        if ($delete_other_services == 1) { setPermission($conn, $role_id, "DELETE_OTHER_SERVICES"); }
                        if ($invoice_other_services == 1) { setPermission($conn, $role_id, "INVOICE_OTHER_SERVICES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_revenues_all == 1) { setPermission($conn, $role_id, "VIEW_REVENUES_ALL"); }
                        if ($view_revenues_assigned == 1 && $view_revenues_all != 1) { setPermission($conn, $role_id, "VIEW_REVENUES_ASSIGNED"); }
                        if ($add_revenues == 1) { setPermission($conn, $role_id, "ADD_REVENUES"); }
                        if ($edit_revenues  == 1) { setPermission($conn, $role_id, "EDIT_REVENUES"); }
                        if ($delete_revenues == 1) { setPermission($conn, $role_id, "DELETE_REVENUES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_projects_all == 1) { setPermission($conn, $role_id, "VIEW_PROJECTS_ALL"); }
                        if ($view_projects_assigned == 1 && $view_projects_all != 1) { setPermission($conn, $role_id, "VIEW_PROJECTS_ASSIGNED"); }
                        if ($add_projects == 1) { setPermission($conn, $role_id, "ADD_PROJECTS"); }
                        if ($edit_projects  == 1) { setPermission($conn, $role_id, "EDIT_PROJECTS"); }
                        if ($delete_projects == 1) { setPermission($conn, $role_id, "DELETE_PROJECTS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_project_budgets_all == 1) { setPermission($conn, $role_id, "VIEW_PROJECT_BUDGETS_ALL"); }
                        if ($view_project_budgets_assigned == 1 && $view_project_budgets_all != 1) { setPermission($conn, $role_id, "VIEW_PROJECT_BUDGETS_ASSIGNED"); }
                        if ($budget_projects_all == 1) { setPermission($conn, $role_id, "BUDGET_PROJECTS_ALL"); }
                        if ($budget_projects_assigned == 1) { setPermission($conn, $role_id, "BUDGET_PROJECTS_ASSIGNED"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_customers == 1) { setPermission($conn, $role_id, "VIEW_CUSTOMERS"); }
                        if ($add_customers == 1) { setPermission($conn, $role_id, "ADD_CUSTOMERS"); }
                        if ($edit_customers  == 1) { setPermission($conn, $role_id, "EDIT_CUSTOMERS"); }
                        if ($delete_customers == 1) { setPermission($conn, $role_id, "DELETE_CUSTOMERS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_customer_groups == 1) { setPermission($conn, $role_id, "VIEW_CUSTOMER_GROUPS"); }
                        if ($add_customer_groups == 1) { setPermission($conn, $role_id, "ADD_CUSTOMER_GROUPS"); }
                        if ($edit_customer_groups  == 1) { setPermission($conn, $role_id, "EDIT_CUSTOMER_GROUPS"); }
                        if ($delete_customer_groups == 1) { setPermission($conn, $role_id, "DELETE_CUSTOMER_GROUPS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_students_all == 1) { setPermission($conn, $role_id, "VIEW_STUDENTS_ALL"); }
                        if ($view_students_assigned == 1 && $view_students_all != 1) { setPermission($conn, $role_id, "VIEW_STUDENTS_ASSIGNED"); }
                        if ($add_students == 1) { setPermission($conn, $role_id, "ADD_STUDENTS"); }
                        if ($edit_students  == 1) { setPermission($conn, $role_id, "EDIT_STUDENTS"); }
                        if ($delete_students == 1) { setPermission($conn, $role_id, "DELETE_STUDENTS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_therapists == 1) { setPermission($conn, $role_id, "VIEW_THERAPISTS"); }
                        if ($add_therapists == 1) { setPermission($conn, $role_id, "ADD_THERAPISTS"); }
                        if ($remove_therapists == 1) { setPermission($conn, $role_id, "REMOVE_THERAPISTS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_caseloads_all == 1) { setPermission($conn, $role_id, "VIEW_CASELOADS_ALL"); }
                        if ($view_caseloads_assigned == 1 && $view_caseloads_all != 1) { setPermission($conn, $role_id, "VIEW_CASELOADS_ASSIGNED"); }
                        if ($add_caseloads == 1) { setPermission($conn, $role_id, "ADD_CASELOADS"); }
                        if ($edit_caseloads  == 1) { setPermission($conn, $role_id, "EDIT_CASELOADS"); }
                        if ($delete_caseloads == 1) { setPermission($conn, $role_id, "DELETE_CASELOADS"); }
                        if ($transfer_caseloads == 1) { setPermission($conn, $role_id, "TRANSFER_CASELOADS"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_salary_comparison_state == 1) { setPermission($conn, $role_id, "VIEW_SALARY_COMPARISON_STATE"); }
                        if ($view_salary_comparison_internal_all == 1) { setPermission($conn, $role_id, "VIEW_SALARY_COMPARISON_INTERNAL_ALL"); }
                        if ($view_salary_comparison_internal_assigned == 1) { setPermission($conn, $role_id, "VIEW_SALARY_COMPARISON_INTERNAL_ASSIGNED"); }
                        if ($view_raise_projection == 1) { setPermission($conn, $role_id, "VIEW_RAISE_PROJECTION"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($dashboard_show_revenues == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_REVENUES_TILE"); }
                        if ($dashboard_show_expenses == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_EXPENSES_TILE"); }
                        if ($dashboard_show_net == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_NET_TILE"); }
                        if ($dashboard_show_employees == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_EMPLOYEES_TILE "); }
                        if ($dashboard_show_contract_days == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_CONTRACT_DAYS_TILE"); }
                        if ($dashboard_show_budget_errors_all == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_BUDGET_ERRORS_ALL_TILE"); }
                        if ($dashboard_show_budget_errors_assigned == 1 && $dashboard_show_budget_errors_all != 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_BUDGET_ERRORS_ASSIGNED_TILE"); }
                        if ($dashboard_show_maintenance_mode == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_MAINTENANCE_MODE_TILE"); }
                        if ($dashboard_show_caseloads_all == 1) { setPermission($conn, $role_id, "DASHBOARD_SHOW_CASELOADS_ALL_TILE"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($view_service_contracts == 1) { setPermission($conn, $role_id, "VIEW_SERVICE_CONTRACTS"); }
                        if ($view_quarterly_invoices == 1) { setPermission($conn, $role_id, "VIEW_QUARTERLY_INVOICES"); }
                        if ($create_service_contracts == 1) { setPermission($conn, $role_id, "CREATE_SERVICE_CONTRACTS"); }
                        if ($create_quarterly_invoices == 1) { setPermission($conn, $role_id, "CREATE_QUARTERLY_INVOICES"); }
                        if ($build_service_contracts == 1) { setPermission($conn, $role_id, "BUILD_SERVICE_CONTRACTS"); }
                        if ($build_quarterly_invoices == 1) { setPermission($conn, $role_id, "BUILD_QUARTERLY_INVOICES"); }
                        if ($export_invoices == 1) { setPermission($conn, $role_id, "EXPORT_INVOICES"); }
                        ...
                        //
                        ///////////////////////////////////////////////////////////////////////////////////
                        if ($reports_view_misbudgeted_employees_all == 1) { setPermission($conn, $role_id, "VIEW_REPORT_MISBUDGETED_EMPLOYEES_ALL"); }
                        if ($reports_view_misbudgeted_employees_assigned == 1 && $reports_view_misbudgeted_employees_all != 1) { setPermission($conn, $role_id, "VIEW_REPORT_MISBUDGETED_EMPLOYEES_ASSIGNED"); }
                        if ($reports_view_budgeted_inactive_all == 1) { setPermission($conn, $role_id, "VIEW_REPORT_BUDGETED_INACTIVE_EMPLOYEES_ALL"); }
                        if ($reports_view_test_employees_assigned == 1 && $reports_view_budgeted_inactive_all != 1) { setPermission($conn, $role_id, "VIEW_REPORT_BUDGETED_INACTIVE_EMPLOYEES_ASSIGNED"); }
                        ...
                        if ($reports_view_budgeted_inactive_assigned == 1 && $reports_view_test_employees_all != 1) { setPermission($conn, $role_id, "VIEW_REPORT_TEST_EMPLOYEES_ASSIGNED"); }
                        if ($reports_view_salary_projection_all == 1) { setPermission($conn, $role_id, "VIEW_REPORT_SALARY_PROJECTION_ALL"); }
                        if ($reports_view_salary_projection_assigned == 1 && $reports_view_salary_projection_all != 1) { setPermission($conn, $role_id, "VIEW_REPORT_SALARY_PROJECTION_ASSIGNED"); }
                        if ($reports_view_employee_changes_all == 1) { setPermission($conn, $role_id, "VIEW_REPORT_EMPLOYEE_CHANGES_ALL"); }
                        if ($reports_view_employee_changes_assigned == 1 && $reports_view_employee_changes_all != 1) { setPermission($conn, $role_id, "VIEW_REPORT_EMPLOYEE_CHANGES_ASSIGNED"); }
                    
                        echo "<span class=\"log-success\">Successfully</span> created the new role.<br>";
                    }
                    else { echo "<span class=\"log-fail\">Failed</span> to create the role. An unexpected error has occurred! Please try again later.<br>"; }
                }
                catch (Exception $e)
                {
                    echo "<span class=\"log-fail\">Failed</span> to create the new role. An unexpected error has occurred! Please try again later.<br>";
                }

                // disconnect from the database
                mysqli_close($conn);
            }
            else { echo "<span class=\"log-fail\">Failed</span> to create the role. You must provide the role with a name!<br>"; }
        }
    }
?>